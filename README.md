...
So databases objects lives their own life, created by persons that do their best. It can be usefull to be able to detect some wrong design creation (for example foreign keys created across differents schemas...). That's what pglinter was created for.

...
su - postgres -c "/usr/pgsql-${PG_MAJOR_VERSION}/bin/pg_ctl -D /var/lib/pgsql/${PG_MAJOR_VERSION}/data -l /var/lib/pgsql/${PG_MAJOR_VERSION}/data/logfile start"

echo "⏳ Waiting for PostgreSQL to be ready..."
until su - postgres -c "/usr/pgsql-${PG_MAJOR_VERSION}/bin/pg_isready -q"; do

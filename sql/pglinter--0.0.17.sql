/*
pglinter extension SQL file
Auto generated by pgrx.

The ordering of items is not stable, it is driven by a dependency graph.
*/

-- src/lib.rs:15
-- pglinter::hello_pglinter
CREATE  FUNCTION "hello_pglinter"() RETURNS TEXT /* &str */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'hello_pglinter_wrapper';

-- src/lib.rs:20
CREATE SCHEMA IF NOT EXISTS pglinter; /* pglinter::pglinter */

-- src/lib.rs:314
-- pglinter::pglinter::import_rules_from_file
CREATE  FUNCTION pglinter."import_rules_from_file"(
        "file_path" TEXT /* &str */
) RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'import_rules_from_file_wrapper';

-- src/lib.rs:303
-- pglinter::pglinter::import_rules_from_yaml
CREATE  FUNCTION pglinter."import_rules_from_yaml"(
        "yaml_content" TEXT /* &str */
) RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'import_rules_from_yaml_wrapper';

-- src/lib.rs:83
-- pglinter::pglinter::perform_schema_check
...
-- src/lib.rs:64
-- pglinter::pglinter::perform_table_check
...
-- src/lib.rs:164
-- pglinter::pglinter::enable_rule
CREATE  FUNCTION pglinter."enable_rule"(
        "rule_code" TEXT /* &str */
) RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'enable_rule_wrapper';

-- src/lib.rs:175
-- pglinter::pglinter::disable_rule
CREATE  FUNCTION pglinter."disable_rule"(
        "rule_code" TEXT /* &str */
) RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'disable_rule_wrapper';

-- src/lib.rs:259
-- pglinter::pglinter::get_rule_levels
CREATE  FUNCTION pglinter."get_rule_levels"(
        "rule_code" TEXT /* &str */
) RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'get_rule_levels_wrapper';

-- src/lib.rs:118
-- pglinter::pglinter::check_schema
CREATE  FUNCTION pglinter."check_schema"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'check_schema_wrapper';

-- src/lib.rs:208
-- pglinter::pglinter::explain_rule
CREATE  FUNCTION pglinter."explain_rule"(
        "rule_code" TEXT /* &str */
) RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'explain_rule_wrapper';

-- src/lib.rs:197
-- pglinter::pglinter::is_rule_enabled
CREATE  FUNCTION pglinter."is_rule_enabled"(
        "rule_code" TEXT /* &str */
) RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'is_rule_enabled_wrapper';

-- src/lib.rs:45
-- pglinter::pglinter::perform_cluster_check
...
-- src/lib.rs:270
-- pglinter::pglinter::show_rule_queries
CREATE  FUNCTION pglinter."show_rule_queries"(
        "rule_code" TEXT /* &str */
) RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'show_rule_queries_wrapper';

-- src/lib.rs:292
-- pglinter::pglinter::export_rules_to_file
CREATE  FUNCTION pglinter."export_rules_to_file"(
        "file_path" TEXT /* &str */
) RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'export_rules_to_file_wrapper';

-- src/lib.rs:281
-- pglinter::pglinter::export_rules_to_yaml
CREATE  FUNCTION pglinter."export_rules_to_yaml"() RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'export_rules_to_yaml_wrapper';

-- src/lib.rs:103
-- pglinter::pglinter::check_base
CREATE  FUNCTION pglinter."check_base"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'check_base_wrapper';

-- src/lib.rs:26
-- pglinter::pglinter::perform_base_check
...
-- src/lib.rs:186
-- pglinter::pglinter::show_rules
CREATE  FUNCTION pglinter."show_rules"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'show_rules_wrapper';

-- src/lib.rs:123
-- pglinter::pglinter::check_all
CREATE  FUNCTION pglinter."check_all"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'check_all_wrapper';

-- src/lib.rs:244
-- pglinter::pglinter::update_rule_levels
CREATE  FUNCTION pglinter."update_rule_levels"(
        "rule_code" TEXT, /* &str */
        "warning_level" INT, /* core::option::Option<i32> */
        "error_level" INT /* core::option::Option<i32> */
) RETURNS bool /* core::option::Option<bool> */
SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'update_rule_levels_wrapper';

-- src/lib.rs:233
-- pglinter::pglinter::disable_all_rules
CREATE  FUNCTION pglinter."disable_all_rules"() RETURNS INT /* core::option::Option<i32> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'disable_all_rules_wrapper';

-- src/lib.rs:222
-- pglinter::pglinter::enable_all_rules
CREATE  FUNCTION pglinter."enable_all_rules"() RETURNS INT /* core::option::Option<i32> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'enable_all_rules_wrapper';

-- src/lib.rs:325
-- pglinter::pglinter::list_rules
CREATE  FUNCTION pglinter."list_rules"() RETURNS TEXT /* core::option::Option<alloc::string::String> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'list_rules_wrapper';

-- src/lib.rs:108
-- pglinter::pglinter::check_cluster
CREATE  FUNCTION pglinter."check_cluster"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'check_cluster_wrapper';

-- src/lib.rs:113
-- pglinter::pglinter::check_table
CREATE  FUNCTION pglinter."check_table"() RETURNS bool /* core::option::Option<bool> */
STRICT SECURITY DEFINER
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'check_table_wrapper';

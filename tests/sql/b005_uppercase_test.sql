...
CREATE TABLE test_b005_schema."CUSTOMERS_TABLE" (
    ...
    -- Column with lowercase (unquoted - should not trigger)
...
CREATE INDEX "IDX_CUSTOMERS_EMAIL" ON test_b005_schema."CUSTOMERS_TABLE" (
    "EMAIL_ADDRESS"
);
-- lowercase, should not trigger
CREATE INDEX idx_customers_phone ON test_b005_schema."CUSTOMERS_TABLE" (
    phone_number
);
...
CREATE TYPE test_B005_schema."CUSTOMER_STATUS" AS ENUM (
...
INSERT INTO test_b005_schema."CUSTOMERS_TABLE" (
...
SELECT
    'Testing B005 rule - Comprehensive uppercase object detection...' AS test_info;
...
SELECT
    'Running B005 check to detect comprehensive uppercase violations...' AS status;
